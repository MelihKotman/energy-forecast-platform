        ...
        <div className="flex min-h-screen overflow-hidden">
          ...
          <aside className="w-64 hidden md:flex flex-col shadow-2xl z-20 shrink-0" style={{ backgroundColor: THEME.sidebarBg }}>
            ...
            <nav className="flex-1 px-4 mt-6 space-y-2">
              ...
              {/* YENİ: Model Metrikleri Rotası */}
              <Link href="/analytics" className="flex items-center gap-4 px-4 py-3 rounded-xl hover:bg-teal-400/10 hover:text-teal-400 text-gray-400 border border-transparent hover:border-teal-400/20 cursor-pointer transition-all">
                ...
                <span className="font-semibold text-sm">Model Metrikleri</span>
              </Link>

              <Link href="/settings" className="flex items-center gap-4 px-4 py-3 rounded-xl text-gray-400 hover:text-white hover:bg-[#1A2B56] cursor-pointer transition-all">
